...
func generate_ingredient_request() -> void:
	...
	request_description = "This is the guild informing you that " + requester + " has requested that you retrieve %s %s. Upon completing the request you'll receive %sgs" % [request_count, request_needed, request_value]
...
func generate_bottle_request() -> void:
	...
	request_description = "This is the guild informing you that " + requester + " has requested that you make %s %s potions. Upon completing the request you'll receive %sgs" % [request_count, request_needed, request_value]
